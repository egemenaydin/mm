df <- read.csv("yuzeysel_su_CYA_biomass_norm.csv")
df2 <- df[-1]
...
gplots::heatmap.2(as.matrix(df3[,-11]), Rowv = T, Colv = T, 
...
dev.print(png, file = "biomass_norm_heatmap2.png", height=9, width=12, res = 600,
          units = "in")
