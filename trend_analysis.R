...
df <- read.csv("base_in_feature_extract.csv")
...
df_decrease <- filter(df, Camelina.tp0 / Camelina.tp1 > 3 | Camelina.tp0 / Camelina.tp2 > 3 & Camelina.tp0 / No.fuel.tp0 >3)
...
library(RColorBrewer)
df <- read.csv("base_in_feature_extract.csv")
df <- select(df, mz, rt, FE14.tp0.a:FE20.tp4.b)
#df <- baseC_long

data.frame(df, df$F76.tp0 <- apply(select(df, FE15.tp0.a, FE15.tp0.b), 1, mean))
data.frame(df, df$F76.tp1 <- apply(select(df, FE15.tp2.a, FE15.tp2.b), 1, mean))
data.frame(df, df$F76.tp2 <- apply(select(df, FE15.tp4.a, FE15.tp4.b), 1, mean))
data.frame(df, df$No.fuel.tp0 <- apply(select(df, FE20.tp0.a, FE20.tp0.b), 1, mean))
data.frame(df, df$No.fuel.tp1 <- apply(select(df, FE20.tp2.a, FE20.tp2.b), 1, mean))
data.frame(df, df$No.fuel.tp2 <- apply(select(df, FE20.tp4.a, FE20.tp4.b), 1, mean))

data.frame(df, df$F76.abiotic.tp0 <- apply(select(df, FE14.tp0.a, FE14.tp0.b), 1, mean))
data.frame(df, df$F76.abiotic.tp1 <- apply(select(df, FE14.tp2.a, FE14.tp2.b), 1, mean))
data.frame(df, df$F76.abiotic.tp2 <- apply(select(df, FE14.tp4.a, FE14.tp4.b), 1, mean))
data.frame(df, df$No.fuel.abiotic.tp0 <- apply(select(df, FE19.tp0.a, FE19.tp0.b), 1, mean))
data.frame(df, df$No.fuel.abiotic.tp1 <- apply(select(df, FE19.tp2.a, FE19.tp2.b), 1, mean))
data.frame(df, df$No.fuel.abiotic.tp2 <- apply(select(df, FE19.tp4.a, FE19.tp4.b), 1, mean))

data.frame(df, df$F76.tp0.sd <- apply(select(df, FE15.tp0.a, FE15.tp0.b), 1, sd))
data.frame(df, df$F76.tp1.sd <- apply(select(df, FE15.tp2.a, FE15.tp2.b), 1, sd))
data.frame(df, df$F76.tp2.sd <- apply(select(df, FE15.tp4.a, FE15.tp4.b), 1, sd))
data.frame(df, df$No.fuel.tp0.sd <- apply(select(df, FE20.tp0.a, FE20.tp0.b), 1, sd))
data.frame(df, df$No.fuel.tp1.sd <- apply(select(df, FE20.tp2.a, FE20.tp2.b), 1, sd))
data.frame(df, df$No.fuel.tp2.sd <- apply(select(df, FE20.tp4.a, FE20.tp4.b), 1, sd))

data.frame(df, df$F76.abiotic.tp0.sd <- apply(select(df, FE14.tp0.a, FE14.tp0.b), 1, sd))
data.frame(df, df$F76.abiotic.tp1.sd <- apply(select(df, FE14.tp2.a, FE14.tp2.b), 1, sd))
data.frame(df, df$F76.abiotic.tp2.sd <- apply(select(df, FE14.tp4.a, FE14.tp4.b), 1, sd))
data.frame(df, df$No.fuel.abiotic.tp0.sd <- apply(select(df, FE19.tp0.a, FE19.tp0.b), 1, sd))
data.frame(df, df$No.fuel.abiotic.tp1.sd <- apply(select(df, FE19.tp2.a, FE19.tp2.b), 1, sd))
data.frame(df, df$No.fuel.abiotic.tp2.sd <- apply(select(df, FE19.tp4.a, FE19.tp4.b), 1, sd))

df_decrease <- filter(df, F76.tp0 / F76.tp1 > 3 | F76.tp0 / F76.tp2 > 3 & F76.tp0 / No.fuel.tp0 >3)
df_increase <- filter(df, F76.tp1 / F76.tp0 > 3 | F76.tp2 / F76.tp0 > 3 & F76.tp2 / No.fuel.tp2 >3)
...
inc <- read.csv("increase2.csv", check.names = FALSE)
dec <- read.csv("Camelina-rsw-change.csv", check.names = FALSE)
...
#sterile seawater Camelina
df <- read.csv("base_in_feature_extract.csv")
df <- select(df, mz, rt, FE4.tp0.a:FE18.tp4.b)
#df <- baseC_long

data.frame(df, df$Camelina.tp0 <- apply(select(df, FE3.tp0.a, FE3.tp0.b), 1, mean))
data.frame(df, df$Camelina.tp1 <- apply(select(df, FE3.tp2.a, FE3.tp2.b), 1, mean))
data.frame(df, df$Camelina.tp2 <- apply(select(df, FE3.tp4.a, FE3.tp4.b), 1, mean))
data.frame(df, df$No.fuel.tp0 <- apply(select(df, FE18.tp0.a, FE18.tp0.b), 1, mean))
data.frame(df, df$No.fuel.tp1 <- apply(select(df, FE18.tp2.a, FE18.tp2.b), 1, mean))
data.frame(df, df$No.fuel.tp2 <- apply(select(df, FE18.tp4.a, FE18.tp4.b), 1, mean))
...
data.frame(df, df$Camelina.tp0.sd <- apply(select(df, FE3.tp0.a, FE3.tp0.b), 1, sd))
data.frame(df, df$Camelina.tp1.sd <- apply(select(df, FE3.tp2.a, FE3.tp2.b), 1, sd))
data.frame(df, df$Camelina.tp2.sd <- apply(select(df, FE3.tp4.a, FE3.tp4.b), 1, sd))
data.frame(df, df$No.fuel.tp0.sd <- apply(select(df, FE18.tp0.a, FE18.tp0.b), 1, sd))
data.frame(df, df$No.fuel.tp1.sd <- apply(select(df, FE18.tp2.a, FE18.tp2.b), 1, sd))
data.frame(df, df$No.fuel.tp2.sd <- apply(select(df, FE18.tp4.a, FE18.tp4.b), 1, sd))
...
#sterile seawater F76
df <- read.csv("base_in_feature_extract.csv")
df <- select(df, mz, rt, FE14.tp0.a:FE18.tp4.b)
#df <- baseC_long

data.frame(df, df$F76.tp0 <- apply(select(df, FE13.tp0.a, FE13.tp0.b), 1, mean))
data.frame(df, df$F76.tp1 <- apply(select(df, FE13.tp2.a, FE13.tp2.b), 1, mean))
data.frame(df, df$F76.tp2 <- apply(select(df, FE13.tp4.a, FE13.tp4.b), 1, mean))
data.frame(df, df$No.fuel.tp0 <- apply(select(df, FE18.tp0.a, FE18.tp0.b), 1, mean))
data.frame(df, df$No.fuel.tp1 <- apply(select(df, FE18.tp2.a, FE18.tp2.b), 1, mean))
data.frame(df, df$No.fuel.tp2 <- apply(select(df, FE18.tp4.a, FE18.tp4.b), 1, mean))
...
data.frame(df, df$F76.tp0.sd <- apply(select(df, FE13.tp0.a, FE13.tp0.b), 1, sd))
data.frame(df, df$F76.tp1.sd <- apply(select(df, FE13.tp2.a, FE13.tp2.b), 1, sd))
data.frame(df, df$F76.tp2.sd <- apply(select(df, FE13.tp4.a, FE13.tp4.b), 1, sd))
data.frame(df, df$No.fuel.tp0.sd <- apply(select(df, FE18.tp0.a, FE18.tp0.b), 1, sd))
data.frame(df, df$No.fuel.tp1.sd <- apply(select(df, FE18.tp2.a, FE18.tp2.b), 1, sd))
data.frame(df, df$No.fuel.tp2.sd <- apply(select(df, FE18.tp4.a, FE18.tp4.b), 1, sd))
...
#sterile seawater FTF76
df <- read.csv("base_in_feature_extract.csv")
df <- select(df, mz, rt, FE9.tp0.a:FE18.tp4.b)
#df <- baseC_long

data.frame(df, df$FTF76.tp0 <- apply(select(df, FE8.tp0.a, FE8.tp0.b), 1, mean))
data.frame(df, df$FTF76.tp1 <- apply(select(df, FE8.tp2.a, FE8.tp2.b), 1, mean))
data.frame(df, df$FTF76.tp2 <- apply(select(df, FE8.tp4.a, FE8.tp4.b), 1, mean))
data.frame(df, df$No.fuel.tp0 <- apply(select(df, FE18.tp0.a, FE18.tp0.b), 1, mean))
data.frame(df, df$No.fuel.tp1 <- apply(select(df, FE18.tp2.a, FE18.tp2.b), 1, mean))
data.frame(df, df$No.fuel.tp2 <- apply(select(df, FE18.tp4.a, FE18.tp4.b), 1, mean))

data.frame(df, df$FTF76.abiotic.tp0 <- apply(select(df, FE9.tp0.a, FE9.tp0.b), 1, mean))
data.frame(df, df$FTF76.abiotic.tp1 <- apply(select(df, FE9.tp2.a, FE9.tp2.b), 1, mean))
data.frame(df, df$FTF76.abiotic.tp2 <- apply(select(df, FE9.tp4.a, FE9.tp4.b), 1, mean))
data.frame(df, df$No.fuel.abiotic.tp0 <- apply(select(df, FE19.tp0.a, FE19.tp0.b), 1, mean))
data.frame(df, df$No.fuel.abiotic.tp1 <- apply(select(df, FE19.tp2.a, FE19.tp2.b), 1, mean))
data.frame(df, df$No.fuel.abiotic.tp2 <- apply(select(df, FE19.tp4.a, FE19.tp4.b), 1, mean))

data.frame(df, df$FTF76.tp0.sd <- apply(select(df, FE8.tp0.a, FE8.tp0.b), 1, sd))
data.frame(df, df$FTF76.tp1.sd <- apply(select(df, FE8.tp2.a, FE8.tp2.b), 1, sd))
data.frame(df, df$FTF76.tp2.sd <- apply(select(df, FE8.tp4.a, FE8.tp4.b), 1, sd))
data.frame(df, df$No.fuel.tp0.sd <- apply(select(df, FE18.tp0.a, FE18.tp0.b), 1, sd))
data.frame(df, df$No.fuel.tp1.sd <- apply(select(df, FE18.tp2.a, FE18.tp2.b), 1, sd))
data.frame(df, df$No.fuel.tp2.sd <- apply(select(df, FE18.tp4.a, FE18.tp4.b), 1, sd))

data.frame(df, df$FTF76.abiotic.tp0.sd <- apply(select(df, FE9.tp0.a, FE9.tp0.b), 1, sd))
data.frame(df, df$FTF76.abiotic.tp1.sd <- apply(select(df, FE9.tp2.a, FE9.tp2.b), 1, sd))
data.frame(df, df$FTF76.abiotic.tp2.sd <- apply(select(df, FE9.tp4.a, FE9.tp4.b), 1, sd))
data.frame(df, df$No.fuel.abiotic.tp0.sd <- apply(select(df, FE19.tp0.a, FE19.tp0.b), 1, sd))
data.frame(df, df$No.fuel.abiotic.tp1.sd <- apply(select(df, FE19.tp2.a, FE19.tp2.b), 1, sd))
data.frame(df, df$No.fuel.abiotic.tp2.sd <- apply(select(df, FE19.tp4.a, FE19.tp4.b), 1, sd))

df_decrease <- filter(df, FTF76.tp0 / FTF76.tp1 > 3 | FTF76.tp0 / FTF76.tp2 > 3 & FTF76.tp0 / No.fuel.tp0 >3)
df_increase <- filter(df, FTF76.tp1 / FTF76.tp0 > 3 | FTF76.tp2 / FTF76.tp0 > 3 & FTF76.tp2 / No.fuel.tp2 >3)
...
dev.print(pdf, "FTF76_increase_decrease_hist.pdf", height = 5, width = 10)
