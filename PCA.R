...
with(y[1:3, ], points(PC1, PC2, col = "cornsilk2", pch = 20, cex = 1.7))
with(y[4:6, ], points(PC1, PC2, col = "cornsilk4", pch = 20, cex = 1.7))
with(y[7:9, ], points(PC1, PC2, col = "plum1", pch = 20, cex = 1.7))
with(y[10:12, ], points(PC1, PC2, col = "plum4", pch = 20, cex = 1.7))
with(y[13:15, ], points(PC1, PC2, col = "yellow", pch = 20, cex = 1.7))
with(y[16:18, ], points(PC1, PC2, col = "yellow4", pch = 20, cex = 1.7))
with(y[19:21, ], points(PC1, PC2, col = "navyblue", pch = 20, cex = 1.7))
with(y[22:24, ], points(PC1, PC2, col = "deepskyblue", pch = 20, cex = 1.7))
with(y[25:27, ], points(PC1, PC2, col = "turquoise", pch = 20, cex = 1.7))
with(y[28:30, ], points(PC1, PC2, col = "steelblue4", pch = 20, cex = 1.7))
with(y[31:33, ], points(PC1, PC2, col = "red4", pch = 20, cex = 1.7))
with(y[34:36, ], points(PC1, PC2, col = "red", pch = 20, cex = 1.7))
with(y[37:39, ], points(PC1, PC2, col = "palevioletred1", pch = 20, cex = 1.7))
with(y[40:42, ], points(PC1, PC2, col = "salmon", pch = 20, cex = 1.7))
with(y[43:45, ], points(PC1, PC2, col = "forestgreen", pch = 20, cex = 1.7))
with(y[46:48, ], points(PC1, PC2, col = "darkolivegreen1", pch = 20, cex = 1.7))
with(y[49:51, ], points(PC1, PC2, col = "orange", pch = 20, cex = 1.7))
with(y[52:54, ], points(PC1, PC2, col = "darkorange", pch = 20, cex = 1.7))
