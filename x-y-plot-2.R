...
ggplot(data, aes(x = Sample, y = Abundance)) + 
        geom_rect(data=NULL,aes(xmin=0.25,xmax=4.5,ymin=-Inf,ymax=Inf), fill="#000000", alpha = 0.05) +
        geom_rect(data=NULL,aes(xmin=4.5,xmax=10.5,ymin=-Inf,ymax=Inf), fill="#F0E442", alpha = 0.05) +
        geom_rect(data=NULL,aes(xmin=10.5,xmax=11.5,ymin=-Inf,ymax=Inf), fill="#56B4E9", alpha = 0.05) +
        geom_rect(data=NULL,aes(xmin=11.5,xmax=12.5,ymin=-Inf,ymax=Inf), fill="#009E73", alpha = 0.05) +
        geom_rect(data=NULL,aes(xmin=12.5,xmax=18.75,ymin=-Inf,ymax=Inf), fill="#D55E00", alpha = 0.05) +
