...
data <- read.csv("~/bacteria_silva.csv", header = TRUE, check.names = FALSE)
data2 <- read.csv("~/bacteria_silva.csv", header = TRUE, check.names = FALSE)
...
dev.print(pdf, file = "loadings_silva.pdf", height=7, width=11)
